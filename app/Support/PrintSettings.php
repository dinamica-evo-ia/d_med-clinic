...
class PrintSettings
{
    ...
    // Formatos de papel da receita (Imprimir + PDF). Padrão: A5 RETRATO (papel A5 na impressora).
    public const PAPERS = ['a5_portrait', 'a5_landscape', 'a4_portrait'];

    /** Receita compacta (fonte menor) — formatos A5. */
    public static function isCompact(array $settings): bool
    {
        return in_array($settings['paper'] ?? '', ['a5_portrait', 'a5_landscape'], true);
    }
    ...
    public static function paperFor(array $settings): array
    {
        ...
        return match ($paper) {
            ...
            default         => ['a5', 'portrait'], // a5_portrait (padrão)
        };
    }
